...
public class Sample_TC_S_01_Story_134_SignIn_Fail extends Custom_Utilties {
	...
	public void S_01_Story_134_SignIn() {
		...
		// String expected_Text_SignOut =
		// properties.getProperty(Constants.Properties_Password);
